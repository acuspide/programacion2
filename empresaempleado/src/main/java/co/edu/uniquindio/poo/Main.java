...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("7. Lista Proyectos");
            System.out.println("0. Salir");
            System.out.print("Seleccione una opción: ");
            opcion = scanner.nextInt();
            scanner.nextLine(); // cor malo

            switch (opcion) {
                case 1:
                    agregarGerente(empresa, scanner);
                    break;
                case 2:
                    agregarTecnico(empresa, scanner);
                    break;
                case 3:
                    agregarDepartamento(empresa, scanner);
                    break;
                case 4:
                    agregarProyecto(empresa, scanner);
                    break;
                case 5:
    ...
    private static void agregarGerente(Empresa empresa, Scanner scanner) {
    ...
    private static void agregarTecnico(Empresa empresa, Scanner scanner) {
    ...
    private static void agregarDepartamento(Empresa empresa, Scanner scanner) {
        System.out.print("Ingrese nombre del departamento: ");
        String nombre = scanner.nextLine();
    ...
    private static void agregarProyecto(Empresa empresa, Scanner scanner) {
